...
<html>
    ...
    <body>
        ...
        <div id="show-evidencia" class="content scaffold-show" role="main">
            ...
            <f:display bean="evidencia" />
            <g:form resource="${this.evidencia}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.evidencia}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
